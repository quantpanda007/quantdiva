/**
 * Digital Option — instrument module (placeholder)
 *
...
const digital_option = {
  ...
  flatFields: null,   // null = use FIELDS['digital_option'] from schema_master

  apiType: 'digital_option',
...
INSTRUMENT_REGISTRY['digital_option'] = digital_option;
